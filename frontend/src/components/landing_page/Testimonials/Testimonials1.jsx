...
export default function Testimonials1({ aiContent }) {
  const defaultContent = {
    ...
    testimonials: [
      {
        text: "Une solution exceptionnelle qui a transformé notre façon de travailler. L'équipe est réactive et les fonctionnalités parfaitement adaptées.",
        name: "Marie Dubois",
        role: "Directrice Marketing",
        rating: 5
      },
      {
        text: "Service remarquable et résultats au-delà de nos attentes. Nous recommandons vivement cette solution.",
        name: "Pierre Martin",
        role: "CEO TechStart",
        rating: 5
      }
