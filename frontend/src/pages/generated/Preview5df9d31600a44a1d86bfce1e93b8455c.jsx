...
export default function Preview5df9d31600a44a1d86bfce1e93b8455c() {
    const handleGoBack = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-purple-600 italic">
                                    "un site d\'association poker à montpellier. Poker Fun 34. Mon mail poker@gmail.com, Je souhaite fair..."
                                </p>
                            </div>
                        </div>
            ...
            <div className="website-content">
                    <Navbar1 aiContent={{"brandName": "Poker Fun 34", "navItems": ["Accueil", "Tournois", "Adhésion", "Contact"], "ctaText": "Rejoignez-nous"}} />
                    <Hero2 aiContent={{"title": "Devenez le Maître du Poker à Montpellier", "subtitle": "Rejoignez Poker Fun 34, participez à des tournois MTT et améliorez vos compétences avec des passionnés du poker.", "ctaText": "Inscrivez-vous maintenant", "secondaryCtaText": "En savoir plus"}} />
                    <Features1 aiContent={{"sectionTitle": "Rejoignez Poker Fun 34 et découvrez nos services!", "sectionSubtitle": "Vivez votre passion du poker dans une ambiance conviviale et compétitive.", "features": [{"title": "Tournois MTT réguliers", "description": "Participez à nos compétitions MTT régulières et mesurez-vous aux meilleurs joueurs de la région."}, {"title": "Apprentissage et perfectionnement", "description": "Apprenez les bases ou améliorez votre jeu grâce à nos sessions de coaching et nos ressources pédagogiques."}, {"title": "Communauté amicale et dynamique", "description": "Rencontrez et échangez avec d'autres passionnés de poker dans une atmosphère amicale et conviviale."}]}} />
                    <Footer2 aiContent={{"brandName": "Poker Fun 34", "description": "Association de poker à Montpellier qui organise des tournois MTT conviviaux.", "links": {"company": ["À propos", "Notre équipe", "Adhésion"], "events": ["Prochain tournoi", "Résultats", "Classements"], "support": ["Contact", "Règles du poker", "FAQ"]}, "contact": {"email": "poker@gmail.com"}}} />
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-gray-600 mb-3">
                            Composants sélectionnés automatiquement • Contenu personnalisé • 19/07/2025 à 08:04
                        </p>
